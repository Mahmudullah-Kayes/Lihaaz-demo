        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/category" className="text-sm text-gray-500 hover:text-black">New Arrivals</Link></li>
              <li><Link to="/category" className="text-sm text-gray-500 hover:text-black">Women's Collection</Link></li>
              <li><Link to="/category" className="text-sm text-gray-500 hover:text-black">Men's Collection</Link></li>
              <li><Link to="/category" className="text-sm text-gray-500 hover:text-black">Accessories</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-500 hover:text-black">Sustainability</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-black">Careers</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-black">Press</a></li>
            </ul>
          </div>
